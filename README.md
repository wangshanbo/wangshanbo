...
| **Hardware OEM relationships I personally manage** | **6 categories · 6 factory owners** — not just contacts. I run the **periodic operational calls** with each owner and **co-author the hardware architecture decisions** with them. Two concrete examples: (a) led the lighting-control radio evolution **ZigBee → 433MHz → LoRa** as venue density scaled past what ZigBee mesh could carry; (b) participated in the **motherboard generation upgrade** for our Android order pads (board selection, BOM negotiation, firmware compatibility). I'm effectively the **hardware architecture lead** even though the job title says "sourcing". |
...
- **Hardware × AI**: I'm effectively the **hardware architecture lead** for 6 product categories — periodic operational calls and co-authored architecture decisions with the OEM owners (e.g. drove the lighting-control radio evolution **ZigBee → 433MHz → LoRa**, ran the Android order-pad **motherboard generation upgrade**). **Result: I can prototype an AI hardware device in 2 weeks, not 6 months — because I already speak the OEM owners' language**
